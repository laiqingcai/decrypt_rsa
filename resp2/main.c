...
int ReadRsaKey(void)
{
    ...
    if (( fpriv = fopen("./rsa_pub.txt", "rb")) == NULL)  {
...
void TestRsa(void)
{
  ...
  unsigned char buf[1024] = "K0wmH307ELjq+V79gkoqDoCLJVNHjCClf5s8zJmscwl4iKtYNoEUGJ9TeWB/mqmvxRZPXhu1Kkm12uTV6uP3cjxTyXvHfxBZIked/HvzAdbfWMcTWGUNjIcr0YOg6TxTxkeh15CSVMJcyUumzwkXgGD1zuzZkPtJhCYEFI1q2ss=";
